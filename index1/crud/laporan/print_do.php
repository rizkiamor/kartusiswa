...
$kdprint = $_POST['kdprint'];
$pdo=$saripdo->prepare("select*from tb_do where Nomor_DO='$kdprint' ");
$pdo->execute();
$keluar=$pdo->fetch();
$no = $keluar['Nomor_DO'];
...
<div class="container">
   ...
   <table class="table">
     ...
     <td colspan="3"><button type="submit" class="btn btn-danger pull-center">Print DO</button></td>
   </table>
 </div>
